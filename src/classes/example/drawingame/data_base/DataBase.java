...
public class DataBase {
    ...
    //    public final static String ATTRIBUTE_BAN_ID = "banId";
...
//    public static boolean isCreated = false;
    ...
    public static void init() {
        try {
            ...
            thisDeviceId = ((TelephonyManager) Utils.appContext.getSystemService(Context.TELEPHONY_SERVICE)).getDeviceId();
