...
//        drawingHeight = drawingBitmap.getHeight();
        ...
        if (!isInWidthDialog) {
//            LinearLayout.LayoutParams params = Utils.scaleToLl(bitmap.getWidth(), bitmap.getHeight(),
...
//            requestLayout();
            ...
            RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(Utils.displayMetrics.widthPixels,
                    Utils.displayMetrics.heightPixels / 3);
