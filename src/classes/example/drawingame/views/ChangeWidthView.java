...
/**
 * Realizes canvas change width view
 */
...
public class ChangeWidthView extends View {
    ...
    public ChangeWidthView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ChangeWidthView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public ChangeWidthView(DrawingActivity drawingActivity) {
...
//        layoutParams.gravity = Gravity.CENTER;
    ...
    public void save(String drawingName) {
        ...
        try {
            ...
            Show.toast(drawingActivity, "Error while writing to disk");
            e.printStackTrace();
        }
    }
